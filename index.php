    ...
    <div class="col">
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <form action="https://mailthis.to/rakeembattle90@gmail.com" method="POST" encType="multipart/form-data"
                    class="form">
                    ...
                    <div class="form__group u-margin-top">
                        ...
                        <input type="email" name="_replyto" class="form-control" placeholder="Email address" id="email"
                            required>
                    </div>
                    <div class="form__group u-margin-top">
